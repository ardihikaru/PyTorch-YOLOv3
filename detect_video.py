...
if __name__ == "__main__":
    ...
    # cap = cv.VideoCapture("http://140.113.86.92:10000/drone-1.flv")
    ...
    while (cap.isOpened()):
        ...
        try:
            ...
            # print()
            # # Configure input
            # input_imgs = Variable(frame.type(Tensor))
            # # input_imgs = Variable(input_imgs.type(Tensor))
            #
            # Get detections
            # with torch.no_grad():
    ...
    if run_img:
        ...
        for img_i, (path, detections) in enumerate(zip(imgs, img_detections)):
            ...
            if detections is not None:
                ...
                print(" >> total unique_labels = ", len(unique_labels))
